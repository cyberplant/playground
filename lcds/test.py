# Code obtained from: https://gist.github.com/DenisFromHR/cc863375a6e19dce359d

# Modified by @cyberplant to be able to use multiple LCDs.

from time import sleep
from multiLCD import MultipleLCDs

mylcd = MultipleLCDs([0x3f, 0x27])
...
for i in [0x80, 0x85, 0x8A, 0x8F, 0x94, 0x99, 0x9E, 0xA3]:
    mylcd.lcd_write(i)
    mylcd.lcd_write_char(0)
    mylcd.lcd_write_char(1)
    mylcd.lcd_write_char(2)
# Write next three chars to row 2 directly
for i in [0xC0, 0xC5, 0xCA, 0xCF, 0xD4, 0xD9, 0xDE, 0xE3]:
    mylcd.lcd_write(i)
